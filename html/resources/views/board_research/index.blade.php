    ...
    <div class="bg-primary rounded-xl p-4 mb-6">
        <form action="{{ route('board-research.index') }}" method="GET">
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <a href="{{ route('board-research.index') }}" class="inline-flex items-center justify-center h-12 px-5 bg-point text-cdark rounded-xl hover:bg-opacity-90 transition-all">
