...
<div class="min-h-screen bg-primary">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
            ...
            <form action="{{ route('board-research.update', $post->idx) }}" method="POST" enctype="multipart/form-data" class="space-y-6" onsubmit="showLoadingManager()">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end gap-3 pt-6">
                    <a href="{{ route('board-research.show', $post->idx) }}" 
...
function deleteThumbnail(button) {
    fetch(`/board-research/{{ $post->idx }}/thumbnail`, {
        method: 'DELETE',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
            'Accept': 'application/json',
