...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
    ...
    <div class="bg-primary rounded-xl p-4 mb-6">
        <form action="{{ route('board-content.index') }}" method="GET">
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <a href="{{ route('board-content.index') }}" class="inline-flex items-center justify-center h-12 px-5 bg-point text-cdark rounded-xl hover:bg-opacity-90 transition-all">
    ...
    <!-- 숨겨진 폼 (필터용) -->
    <form id="filterForm" action="{{ route('board-content.index') }}" method="GET" class="hidden">
