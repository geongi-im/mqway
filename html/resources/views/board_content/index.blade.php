    ...
    <div class="bg-primary rounded-xl p-4 mb-6">
        <form action="{{ route('board-content.index') }}" method="GET">
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <a href="{{ route('board-content.index') }}" class="inline-flex items-center justify-center h-12 px-5 bg-white text-cdark rounded-xl hover:bg-gray-50 transition-all">
