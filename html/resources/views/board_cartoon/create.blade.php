...
<div class="relative bg-[#3D4148] py-12 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10 text-center">
        <h1 class="text-3xl font-bold text-white mb-2">인사이트 만화 업로드</h1>
        <p class="text-gray-400 text-sm">재미있는 경제 만화를 공유해주세요.</p>
    </div>
</div>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8 md:p-10">
                <form action="{{ route('board-cartoon.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                        ...
                        <div class="thumbnail-upload-container">
                            <div class="relative">
                                ...
                                <div class="w-full h-12 px-4 border border-gray-200 rounded-xl bg-gray-50 flex items-center justify-between cursor-pointer hover:border-[#9F5AFF] transition-all">
                                    <span class="thumbnail-label text-gray-500 font-medium text-sm">썸네일 이미지를 선택하세요</span>
                    ...
                    <div class="space-y-4 pt-6 border-t border-gray-100">
                        <div class="flex justify-between items-end">
                            <div>
                                <label class="text-sm font-semibold text-[#2D3047] block mb-1">만화 이미지 첨부</label>
                    ...
                    <div class="flex items-center justify-between pt-8 border-t border-gray-100 mt-8">
                        <button type="button" 
                                onclick="if(confirm('작성 중인 내용이 저장되지 않고 사라집니다.\n목록 페이지로 돌아가시겠습니까?')) { location.href='{{ route('board-cartoon.index') }}'; }"
...
<script>
    ...
    function addFileInput() {
        ...
        if(inputs.length >= 20) { // 만화는 컷 수가 많을 수 있으므로 20개로 증가
